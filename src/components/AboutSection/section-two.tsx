                    ...
                    <div className="">
                        <div className="lg:w-[400px]">
                            <motion.div
                                ...
                                <p className=" text-md leading-6 rubik-font mt-3">at began as small community gatherings quickly grew into a movement committed to mental health advocacy, spiritual mentorship, and purpose discovery. Today, White Roses Foundation has reached over 1,000 young girls across Nigeria through initiatives like:</p>
